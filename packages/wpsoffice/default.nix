...
mkDerivation rec {
  ...
  src = fetchurl {
    url = "https://wdl1.pcfg.cache.wpscdn.com/wpsdl/wpsoffice/download/linux/11664/wps-office_11.1.0.11664.XA_amd64.deb";
    sha256 = "1xcdcbwgzj1j2ch4d8849cbqqsdxgrn8nlr2b1k1zc17rsm4d9pn";
  };
  unpackCmd = "dpkg -x $src .";
  sourceRoot = ".";

  postUnpack = lib.optionalString (version == "11.1.0.11664") ''
